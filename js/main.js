...
function send(){
	alert('Obrigado pela sua mensagem, entraremos em contato o quanto antes!')
	location.reload();
}

function novaAba(){
	window.open('https://api.whatsapp.com/send/?phone=5512991807596&text=Ol%C3%A1%21+Fiquei+muito+interessado+e+quero+saber+mais%21&type=phone_number&app_absent=0', '_blank');
}